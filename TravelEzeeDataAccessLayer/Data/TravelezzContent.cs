...
public class TravelezzApp:DbContext
{
    string ConString = "Data Source=WKSCHE03TRNG080\\SQLEXPRESS;Initial Catalog =TravelezzApp;Integrated Security=True;Trust Server Certificate=True";
