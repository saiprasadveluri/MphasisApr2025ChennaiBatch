...
namespace TravelEzeeWinUI
{
    public partial class AddNewServiceDialogue : Form
    {
        ...
        private void AddNewServiceDialogue_Load(object sender, EventArgs e)
        {
            ...
            srvtypecombo.DisplayMember = "ServiceTypeName";
        ...
        private void btnaddservice_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (srLoc != null && destLoc != null && servtype != null)
                {
                    ...
                    string srvname = servtype.ServiceTypeName;
        ...
        private void srvtypecombo_SelectedIndexChanged(object sender, EventArgs e)
        {
