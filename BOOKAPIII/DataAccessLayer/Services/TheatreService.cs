...
namespace Book.DataAccessLayer.Services
{
    public class TheatreService : ITheatreService
    {
        ...
        {
            return await _repo.DeleteAsync(theatreId);
        }
        public async Task<TheatreDTO> UpdateAsync(int theatreId, TheatreDTO dto)
        {
            var entity = _mapper.Map<Theatre>(dto);
            var updated = await _repo.UpdateAsync(theatreId, entity);
            return updated != null ? _mapper.Map<TheatreDTO>(updated) : null;
        }
