...
public class TravelEFManagementContext : DbContext
{
    string ConString = "Data Source=DESKTOP-O3SKLBE\\SQLEXPRESS;Initial Catalog=TravelEFManagement;Integrated Security=True;Trust Server Certificate=True";
    public DbSet<Location> locations{ get; set; }
    public DbSet<ServiceType> ServiceType{ get; set; }
    public DbSet<Service> services{ get; set; }
    public DbSet<Booking> bookings{ get; set; }

    public TravelEFManagementContext()
    {
