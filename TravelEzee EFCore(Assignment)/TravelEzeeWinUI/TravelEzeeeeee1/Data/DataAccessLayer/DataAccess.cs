...
public class DataAccess
{
    ...
    {
        var serlist = context.Services.Where(l => l.SourceLocId == SerTypeId || l.DestLocId == SerTypeId);
        context.Services.RemoveRange(serlist);
        var SerTypeList = context.ServiceTypes.FirstOrDefault(serType => serType.STypeId == SerTypeId);
