...
namespace QuizAPI
{
    public class ServicesAPI
    {
        ...
        {
            var result = context.UserInfos
                .Where(c => c.AccountId == id)
                .Select(obj => new GetAccountUserDTO
                {
                    UserId = obj.UserId,
                    AccountId = obj.AccountId,
                    UserName = obj.UserName,
                ...
                .FirstOrDefault(); // Returns single or null
        ...
        public async Task<GetQuestionWithOptionsDTO> GetQuestionWithOptionsByIdAsync(Guid questionId)
        {
            ...
            return new GetQuestionWithOptionsDTO
            {
                ...
                Options = question.Options.Select(o => new GetOptionsDTO
                {
                    OptionId = o.OptionId,
                    OptionText = o.OptionText,
                    Answer = o.Answer
